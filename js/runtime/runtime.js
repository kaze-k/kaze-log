const nol=s=>9<Number(s)?s:"0"+s;function createTime(){var s=Math.round(new Date("03/01/2023 00:00:00").getTime()/1e3);let a=Math.round((new Date).getTime()/1e3)-s;s=new Array("000","00","00","00","00");31536e3<=a&&(s[0]=a/31536e3,a%=31536e3),86400<=a&&(s[1]=Math.floor(a/86400),a%=86400),3600<=a&&(s[2]=nol(Math.floor(a/3600)),a%=3600),60<=a&&(s[3]=nol(Math.floor(a/60)),a%=60),0<=a&&(s[4]=nol(a));let e="";e=Number(s[2])<19&&6<Number(s[2])?`
