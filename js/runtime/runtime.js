var nol=function(s){return 9<s?s:"0"+s};function createTime(){var s=Math.round(new Date("2023-03-1 00:00:00").getTime()/1e3);let a=Math.round((new Date).getTime()/1e3)-s,e=0,n=0,o=0,i=0,t=0,l=(0===e&&(e="0"+e),31536e3<=a&&(e=a/31536e3,a%=31536e3),86400<=a&&(n=Math.floor(a/86400),a%=86400),3600<=a&&(o=nol(Math.floor(a/3600)),a%=3600),60<=a&&(i=nol(Math.floor(a/60)),a%=60),0<=a&&(t=nol(a)),"");l=Number(o)<20&&6<Number(o)?`
